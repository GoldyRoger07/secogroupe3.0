...
@Component({
  ...
  template: `
    <section class="hero-wrapper">
        ...
        <svg class="slider-svg" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="695px" height="571px" viewBox="0 0 695 671" style="border:1px solid transparent;  ">
                <defs>
                ...
                <g style="clip-path:url(#clip-path-right)" id="right" class="start">
                        <image class="double-hero-image-right-04" opacity="0" href="img/services/crop/building_maintenance_2.jpg" width="650" height="671" transform="translate(190 0)"></image>
                        <image class="double-hero-image-right-03" opacity="0" href="img/services/seco_agent_securite_en_bleu.jpg" width="650" height="671" transform="translate(200 0)"></image>
                        <image class="double-hero-image-right-02" opacity="0" href="img/services/crop/housekeeping_services.jpg" width="650" height="671" transform="translate(200 0)"></image>
                        <image class="double-hero-image-right-01" href="img/services/crop/janitorial.jpg" width="650" height="671" transform="translate(200 0)"></image>
                </g>
                <g style="clip-path:url(#clip-path-left)" id="left" class="start">
                        <image class="double-hero-image-left-04" opacity="0" href="img/services/crop/security_guard_female.jpg" width="650" height="671" transform="translate(-150 0)"></image>
                        <image class="double-hero-image-left-03" opacity="0" href="img/services/crop/manager_facility.jpg" width="650" height="671" transform="translate(-150 0)"></image>
                        <image class="double-hero-image-left-02" opacity="0" href="img/services/crop/concierge.jpg" width="650" height="671" transform="translate(-150 0)"></image>
                        <image class="double-hero-image-left-01" href="img/services/crop/housekeeping.jpg" width="650" height="671" transform="translate(-150 0)"></image>
                </g>
        </svg>
